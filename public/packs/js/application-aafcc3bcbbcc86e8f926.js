...
var map = {
	"./animal-form_controller.js": "./app/javascript/controllers/animal-form_controller.js"
};
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function validateAge() {
      console.log(Number(this.ageTarget.textContent));
      this.ageValidationValue = Number(this.ageTarget.textContent) < 1;
    }
  }, {
    key: "counterValueChanged",
    value: function counterValueChanged() {
      this.displayTarget.textContent = this.counterValue;
    }
  }, {
    key: "ageValidationChanged",
    value: function ageValidationChanged() {
      this.ageValidation === true ? this.ageTarget.textContent = 'Invalid age' : this.ageTarget.textContent = '';
    }
  }]);
...
_default.targets = ['name', 'display', 'age'];
_default.values = {
  counter: Number,
...
var application = stimulus__WEBPACK_IMPORTED_MODULE_0__["Application"].start(document.documentElement);
...
__webpack_require__(/*! controllers */ "./app/javascript/controllers/index.js");
...
/******/ });
//# sourceMappingURL=application-aafcc3bcbbcc86e8f926.js.map